'''
tudo na vida é imprevisivel temos que saber adptar a qualquer situação sempre pensando 
tanto tendo uma inteligencia racional como emocional.
27/12/2022 revisar a partir da aula 30 
'''
...
matricula = int(input('Insira a sua matricula: '))
